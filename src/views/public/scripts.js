...
function taskToHTML(task) {
  ...
  node.innerHTML =
    ...
    '        <input type="checkbox" ' +
    checked +
    ' aria-label="Checkbox for following text input" onclick="move(this)">' + // setting checkbox
    "      </div>" +
    "    </div>" +
    '    <input type="text" class="form-control" placeholder="Nome da tarefa" value="' +
    task.description +
    '" style="' +
    style +
    '" disabled>' + // setting task description and style
    "  </div>" +
    button +
    ...
    "    <label>Responsável: " +
    task.responsible +
    "</label>" + // setting task responsible
    "  </div>";
